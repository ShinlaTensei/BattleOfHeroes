...
namespace SearchTools
{
    public class RomIncludeViewer : EditorWindow
    {
        ...
        public void OnEnable()
        {
            ...
            includeIcons = new[]
                           {
                               AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Base/Plugins/SearchTools/Textures/ExcludeIcon.png"),
                               AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Base/Plugins/SearchTools/Textures/IncludeIcon.png"),
                               AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Base/Plugins/SearchTools/Textures/UnknownIcon.png"),
                               AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Base/Plugins/SearchTools/Textures/AmbiguousIcon.png"),
                           };
            spritePackingTagIcon = EditorGUIUtility.FindTexture("PreTextureMipMapHigh");
            assetBundleIcons     = new[]
                                   {
                                       AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Base/Plugins/SearchTools/Textures/AssetBundleExcludeIcon.png"),
                                       AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Base/Plugins/SearchTools/Textures/AssetBundleIncludeIcon.png"),
                                       AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Base/Plugins/SearchTools/Textures/AssetBundleUnknownIcon.png"),
                                       AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Base/Plugins/SearchTools/Textures/AssetBundleAmbiguousIcon.png"),
                                   };
